...
class BidG2BService(Base):
    ...
    pub_prcrmnt_lrgclsfc_nm = mapped_column(String(100), comment='공공조달대분류명')
    pub_prcrmnt_midclsfc_nm = mapped_column(String(100), comment='공공조달중분류명')
    pub_prcrmnt_clsfc_no = mapped_column(String(10), comment='공공조달분류번호')
