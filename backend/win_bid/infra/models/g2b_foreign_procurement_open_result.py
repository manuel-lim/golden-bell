...
"""
나라장터 검색조건에 의한 개찰결과 외자 목록 조회 /getOpengResultListInfoFrgcptPPSSrch
...
국제구분코드로 하여 외자에 대한 나라장터 개찰결과 목록(입찰공고번호, 입찰공고명, 개찰일시, 참가업체수, 개찰업체정보, 진행구분코드명, 입력일시, 
예비가격파일존재여부, 공고기관명, 수요기관명)을 조회
"""

class G2BForeignProcurementOpenResult(Base):
    __tablename__ = 'win_bid_g2b_foreign_procurement_open_result'
